...
config.injectableEdgeEnv = () => ({
  parsed: {
    mysql: typeof globalThis !== 'undefined'
      ? globalThis['mysql://root:admin@localhost:3306/fastTraveler']
      : (typeof process !== 'undefined' && process.env && process.env['mysql://root:admin@localhost:3306/fastTraveler']) || undefined
  }
});
